    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.php">Dn Clothing</a>
        ...
        <section class="contact-section bg-black  "id="contact">
            ...
            <div class="container-fluid m-4 px-4 px-lg-5" align="center">
                <div class="row">
                    ...
                    <div class="col-md-4">
                <div class="card">
                        <img class="card-img-top" alt="Bootstrap Thumbnail First" src="assets/img/bella.jpeg" />
                        ...
                        <p class="card-text">
                            <table class="table  table-striped">
                                <tbody>
                                    ...
                                    <tr>  
                                        <td>Nama</td>
                                        <td>Hijab Bella Square</td>
                                    </tr>
                                    <tr>   <td>Ukuran</td><td>110 x 110 cm</td></tr>
                                    <tr>   <td>Warna</td><td>Abu-Abu</td></tr>
                                    <tr>   <td>Stok</td><td>20</td></tr>
                                    <tr>   <td>Harga</td><td>RP. 15.500,00</td></tr>
                                    <tr>   <td>Tipe Pakaian</td><td>1</td></tr>
                                </tbody>
                            </table>
                        </p>
                        <p>
