    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">Dn Clothing</a>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">DN Clothing</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Find Your Daily Outfit Ideas</h2>
                        <a class="btn btn-dark" href="form_pesanan.php">Pesan Sekarang</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="text-white mb-4">DN Clothing</h2>
                        <p class="text-white-50">
                            DN Clothing merupakan toko pakaian tangan kedua yang menyediakan berbagai outfit kekinian untuk perempuan
        ...
        <section class="projects-section bg-light" id="produk">
            <div class="container  px-4">
                <div class="row text-center">
                    <div class="col-md-12">
                        <h1 class="masthead-heading text-uppercase mb-5">PRODUK</h1>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <p class="text-center">Rp.15.500,00</p>
                                        <p>
                                            <a class="btn btn-dark" href="bella.php">Show More</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <p>
                                            <a class="btn btn-dark" href="ailen.php">Show More</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <p>
                                            <a class="btn btn-dark" href="lelana.php">Show More</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
